...
public partial class DevXuongMocContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DESKTOP-GHP029P\\SQLEXPRESS; Database=DevXuongMoc; uid=sa; pwd=123456; MultipleActiveResultSets=True; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C88279FADB84");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CUSTOMER__3214EC27C6498DFD");

            entity.ToTable("CUSTOMER");

            entity.HasIndex(e => e.Username, "UQ__CUSTOMER__B15BE12E1CAE99DA").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ORDERS__3214EC27F782221C");

            entity.ToTable("ORDERS");

            entity.HasIndex(e => e.Idorders, "UQ__ORDERS__99356D841119ADD1").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ORDERS_D__3214EC27F9A636F6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27A833D94A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC27231D6CCE");
